...
import type { BenchmarkRow } from '../pipeline/engine';
...
export function BenchmarkPanel({ onRun }: { onRun: (sizes: number[]) => Promise<BenchmarkRow[]> }) {
  ...
  return (
    <div className="benchmark">
      <button className="button" onClick={run} disabled={busy}>
        {busy ? 'Sweeping…' : 'Sweep capture sizes'}
      </button>
